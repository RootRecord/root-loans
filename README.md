...
RootMC personal and town loans from the Server Reserve.

| Field | Value |
|-------|-------|
| **Folder / artifact** | `root-loans` |
| **Version** | `1.7.0` |
| **Bukkit name** | `Root-Loans` |
| **Paper API** | `26.1` |
| **Author** | Root Record |
| **Website** | https://rootmc.net |
| **Main class** | `com.rootrecord.minecraft.rootloans.RootLoansPlugin` |

## Install

1. Install **[Root-Core](https://github.com/RootRecord/root-core)** first (license/cloud spine for the suite).
2. Download `root-loans-1.7.0.jar` from [Releases](https://github.com/RootRecord/root-loans/releases) or the [plugin catalog](https://rootmc.net/plugins/).
3. Remove any older `root-loans-*.jar` from `plugins/`.
...
| Soft depend | Vault, LuckPerms, Towny |
...
.\build-with-server-jdk.bat :plugins:root-loans:jar
```
...
| This plugin page | https://rootmc.net/plugins/root-loans/ |
...
| GitHub (this repo) | https://github.com/RootRecord/root-loans |
| Releases | https://github.com/RootRecord/root-loans/releases |
