...
1. Purchase / download `root-loans-1.7.0.jar` from BuiltByBit (coming soon) or your licensed RootMC distribution channel.
...
| Releases (version notes) | https://github.com/RootRecord/root-loans/releases |
